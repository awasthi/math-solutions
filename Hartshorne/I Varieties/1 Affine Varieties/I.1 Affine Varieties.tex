...
\begin{proof}[Proof of $(b)$]
  	Let $\dim X = n$. 
  	From (a), $\dim U_i \leq \dim X$. Hence, $\sup \dim U_i \leq \dim X$.
  	Now, consider an ascending chain $X_0 \subsetneq X_1 \subsetneq \cdots \subsetneq X_n$ of distinct irreducible closed subsets of $X$. Choose an open set $U_i$ such that $X_0 \cap U_i \neq \emptyset$. We can choose such $U_i$ because $\{U_i\}$ covers $X$. 
	Then, $U_i \cap X_j \neq \emptyset$ because $X_j \supset X_0$. Hence, $X_0 \cap U_i \subsetneq \cdots \subsetneq X_n \cap U_i$ is an ascending chain of irreducible closed subsets (with respect to the subspace topology) of $U_i$. Hence, $\sup \dim U_i \geq \dim X$.
...
\begin{proof}[Proof of $(e)$]
	...
	Let $X = \mathbb{N}$. Let $\tau = \{ \emptyset, X, \{2,3,\cdots\}, \{3,4,\cdots\}, \cdots}$. 
...
$Y = \{(t^3, t^4, t^5)\}$, so for any $(x,y,z) \in Y$, $y^2-xz =0$, $x^3-yz =0$, and $x^2y-z^2 = 0$. 

...
\begin{proof}[Proof of $(e)$]
	...
	Now, we show that the dimension of $X$ is infinite. We note that any closed set $\{n, n+1, \cdots}$ is irreducible, so we have $X \supsetneq \{2,3,4,\cdots\}\supsetneq \{3,4,5,\cdots\} \cdots $. Hence $\dim X = \infty$. 

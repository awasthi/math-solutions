...
\begin{proof}
  ...
  \cite[Props.~1.1,\ 1.14]{AM69}, the minimal primes in
  $A(Y \cap H)$ correspond to minimal primes containing $I(Y) + (f)$ in $A$,
  which correspond to minimal primes containing $f$ in $A(Y)$.

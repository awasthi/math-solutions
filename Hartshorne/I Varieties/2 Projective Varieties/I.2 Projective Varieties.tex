...
However, we can find hypersurfaces $H_1, H_2$ of degrees 2, 3 respectively, such that $Y = H_1 \cap H_2$...

\end{proof}

\begin{proof} [proof of (d)] I wish I can come up with a proof lol 
\end{proof}

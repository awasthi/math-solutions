...
\begin{problem} [AM Exercise 3.16] Let B be a flat $A$-algebra. Then TFAE:
  \begin{enumi}
    ...
    \item If $M$ is any non-zero $A$-module, them $M_B \neq 0$. 
    \item For every A-module $M$, the mapping $x \mapsto 1 \otimes x$ of M into $M_B$ is injective. 
  \end{enumi}
  \par $B$ is said to be faithfully flat over A
\end{problem}1
\begin{proof}
